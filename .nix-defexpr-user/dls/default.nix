...
rec {
  ...
  dls-epics-aravisgige = callPackage ./dls-epics-aravisgige { inherit buildEpicsModule dls-epics-asyn dls-epics-adcore; };
  dls-epics-streamdevice = callPackage ./dls-epics-streamdevice { inherit buildEpicsModule dls-epics-asyn; };
  dls-epics-pvlogging = callPackage ./dls-epics-pvlogging { inherit buildEpicsModule; };
  dls-epics-adpython = callPackage ./dls-epics-adpython { inherit buildEpicsModule dls-epics-asyn dls-epics-adcore; };
  dls-epics-gensub = callPackage ./dls-epics-gensub { inherit buildEpicsModule; };
  dls-epics-seq = callPackage ./dls-epics-seq { inherit buildEpicsModule; };
  dls-epics-motor = callPackage ./dls-epics-motor { inherit buildEpicsModule dls-epics-busy dls-epics-asyn; };
  dls-epics-pmac = callPackage ./dls-epics-pmac { inherit buildEpicsModule dls-epics-calc dls-epics-busy dls-epics-asyn dls-epics-motor; };
